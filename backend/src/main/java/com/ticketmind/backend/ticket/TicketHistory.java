...
public class TicketHistory {
	...
	// Was JSONB. Comment bodies live in here, which makes this the single
	// largest store of user-authored text after tickets.description, so V3
	// moved the column to TEXT and put it behind the field cipher. Nothing ever
	// queried it with JSONB operators — the audit log is only ever read whole,
	// by ticket — so the only thing given up is a capability nobody used.
